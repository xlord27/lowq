...
[Unit]
Description=Trojan-Go Service Mod By Xlord Tunnel
Documentation=https://github.com/xtls
After=network.target nss-lookup.target
...
wget -O user-vmess "https://raw.githubusercontent.com/xlord27/lowq/main/menu/user-vmess" && chmod +x user-vmess
# vless
...
wget -O user-vless "https://raw.githubusercontent.com/xlord27/lowq/main/menu/user-vless" && chmod +x user-vless
# trojan
...
wget -O del-tr "https://raw.githubusercontent.com/xlord27/lowq/main/xray/del-tr.sh" && chmod +x del-tr
wget -O renew-tr "https://raw.githubusercontent.com/xlord27/lowq/main/xray/renew-tr.sh" && chmod +x renew-tr
wget -O cek-tr "https://raw.githubusercontent.com/xlord27/lowq/main/xray/cek-tr.sh" && chmod +x cek-tr

# trojan go
wget -O addtrgo "https://raw.githubusercontent.com/xlord27/lowq/main/xray/addtrgo.sh" && chmod +x addtrgo
wget -O trialtrojango "https://raw.githubusercontent.com/xlord27/lowq/main/xray/trialtrojango.sh" && chmod +x trialtrojango
wget -O deltrgo "https://raw.githubusercontent.com/xlord27/lowq/main/xray/deltrgo.sh" && chmod +x deltrgo
wget -O renewtrgo "https://raw.githubusercontent.com/xlord27/lowq/main/xray/renewtrgo.sh" && chmod +x renewtrgo
wget -O cektrgo "https://raw.githubusercontent.com/xlord27/lowq/main/xray/cektrgo.sh" && chmod +x cektrgo
